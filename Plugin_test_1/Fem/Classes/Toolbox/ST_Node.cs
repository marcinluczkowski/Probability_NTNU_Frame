...
namespace Propability_NTNU_v1.Classes.Toolbox
{
    ...
    public class Node
    {
        ...
        /// <summary>Find nearest node within tolerance; used to snap load points when exact match fails.</summary>
        public static Node FindNearestNode(Point3d _pt, List<Node> _nodes, double maxDist)
        {
            Node best = null;
            double bestD = maxDist;
            foreach (Node n in _nodes)
            {
                double d = _pt.DistanceTo(n.Pt);
    ...
    public class Param_Node : GH_PersistentParam<GH_Node>
    {
        ...
        public override Guid ComponentGuid => new Guid("3ca97dda-c307-45c3-bc06-2a5c18019b21");
