    ...
    public class ReliabilityIndexCalculator : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                ...
                // The limit state function is G = R - S
                ...
                // FORM implementation for G = R - c * S
                double beta = CalculateFORM(resistanceRv, loadRv, loadMultiplier, out double pf, out double alphaR, out double alphaS);
